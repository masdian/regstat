...
data1 <- data.frame(NIM = data1[, "NIM"], Ajuan = "a01")
data1 <- unique(data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a02")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a03")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a04")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a05")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a06")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan ="a07")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[,"NIM"], Ajuan = "a08")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[, "NIM"], Ajuan = "a09")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[, "NIM"], Ajuan = "a10")
data1 <- unique(data1)
data <- rbind(data, data1)
...
data1 <- data.frame(NIM = data1[, "NIM"], Ajuan = "a11")
data1 <- unique(data1)
data <- rbind(data, data1)
...
Diinformasikan bahawa proses penyesuaian UKT mengalami perubahan. Semula batas waktu pengajuan hingga **17 Juli 2020 pukul 16.00** diperpanjang menjadi **17 Juli 2020 pukul 23.59**, sehingga pengiriman data ke Fakultas baru terealisasi pada hari Senin tanggal **20 Juli 2020**. Dengan demikian, belum ada tanggal pasti untuk **poin 3 hingga poin 5**. Informasi terbaru mengenai kelanjutan proses Penyesuaian UKT akan diinformasikan kemudian di website ini.

...
3. Sesuai dengan SK Rektor Nomor 6/UN43/KPT.TM.01.04/2020 perihal Biaya Kuliah Bagi Yatim dan Yatim Piatu dapat diberlakukan bagi mahasiswa apabila **Ayah meninggal** (Yatim) atau **Ayah dan Ibu meninggal** (Yatim Piatu) dapat catatan ibu kandung tidak menikah lagi.
...
2. **Penyesuaian UKT**
    ...
    a. Surat PHK/Diberhentikan (format pdf)
    b. Kartu Tanda Mahasiwa (format jpg)
    c. Bukti Pembayaran UKT/SPP semester berjalaan (format pdf)
    d. Kartu Keluarga (format pdf)

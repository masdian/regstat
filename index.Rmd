...
2. Memperhatikan kesepakatan Majelis Rektor Perguruan Tinggi Negeri (MRPTN) bagi mahasiswa yang terdampak pandemi untuk mengatasi UKT, terdapat beberapa kebijakan yang akan diberlakukan, di antaranya:
    ...
    a. **Menunda Pembayaran**. Bagi orang tua/mahasiswa yang belum dapat membayar UKT dalam periode pembayaran yang dijadwalkan, dapat mengajukan penundaan pembayaran sesuai mekanisme yang berlaku. Apabila disetujui maka pembaayaran dapat dilakukan pada periode pembayaran susulan yang ditetapkan hingga masa sebelum pelaksanaan Ujian Akhir Semester (UAS)
...
3. Sesuai dengan SK Rektor Nomor 6/UN43/KPT.TM.01.04/2020 perihal Biaya Kuliah Bagi Yatim dan Yatim Piatu dapat diberlakukan bagi mahasiswa apabila **Ayah meninggal** (Yatim) atau **Ayah dan Ibu meninggal** (Yatim Piatu) dapat mengajukan biaya kuliah sama dengan Bidik Misi (**Rp2.400.000/semester**) dengan catatan ibu kandung tidak menikah lagi.

### **Pendaftaran**

Bagi mahasiswa Untirta yang memenuhi kriteria seperti tertera pada surat pemberitahuan nomor T/445/UN43/KU.00.01/2020 bisa melakukan pengajuan dengan melengkapi persyaratan-persyaratan berikut.

1. **Menunda pembarayan/Perpanjangan Pembayaran**

    a. Mengisi formulir pendaftaran yang bisa diunduh di sini.
    b. Bukti penghasilan orang tua terbaru (format pdf)
    c. Kartu Tanda Mahasiwa (format jpg)
    d. Bukti Pembayaran UKT/SPP semester berjalaan (format pdf)
    e. Kartu Keluarga (format pdf)
    f. Setelah persyaratan a - e lengkap, lakukan pendaftaran secara *online* [**di sini**](https://docs.google.com/forms/d/e/1FAIpQLSdEm4szZhgay61yOTdsaCWWGIW6gChpHyzKFVu6RdKMao2z1Q/viewform){target="_blank"}.
  

2. **Penyesuaian UKT**

    a. Mengisi formulir pendaftaran yang bisa diunduh di sini.
    b. Surat PHK/Diberhentikan (format pdf)
    c. Kartu Tanda Mahasiwa (format jpg)
    d. Bukti Pembayaran UKT/SPP semester berjalaan (format pdf)
    e. Kartu Keluarga (format pdf)
    f. Setelah persyaratan a - e lengkap, lakukan pendaftaran secara *online* [**di sini**](https://docs.google.com/forms/d/e/1FAIpQLSdI8Ooa5Qlszp7XkuEUN4_On_TGoS7QI_Sg-tgz8OT_ut2ZWw/viewform){target="_blank"}.
...
3. **Yatim atau Yatim Piatu**
    ...
    d. Bukti Pembayaran UKT/SPP semester berjalaan (format pdf)
    e. Kartu Keluarga (format pdf)
    f. Setelah persyaratan a - e lengkap, lakukan pendaftaran secara *online* [**di sini**](https://docs.google.com/forms/d/e/1FAIpQLScqurvhU869iAcAvh--fOj-G_sfl5cyzlnLulS-9JVfSLQypg/viewform){target="_blank"}.

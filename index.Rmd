...
2. Memperhatikan kesepakatan Majelis Rektor Perguruan Tinggi Negeri (MRPTN) bagi mahasiswa yang terdampak pandemi untuk mengatasi UKT, terdapat beberapa kebijakan yang akan diberlakukan, di antaranya:
    ...
    c. **Penyesuaian UKT**. Bagi orang tua/mahasiswa yang belum dapat melakukan pembayaran UKT dalam periode pembayaran yang dijadwalkan karena terkena **PHK** atau **pensiun** maka dapat mengajukan permohonan pengajuan penyesuaian UKT sesuai mekanisme yang berlaku. Apabila disetujui, **penurunan UKT bagi yang terkena PHK hanya berlaku pada semester Ganjil tahun ajaran 2020/2021** dan akan kembali lagi ke UKT semula pada semester berikutnya
...
Bagi mahasiswa Untirta yang memenuhi kriteria seperti tertera pada surat pemberitahuan nomor T/445/UN43/KU.00.01/2020 bisa melakukan pengajuan sedara *online*. Pengisian formulir **wajib** menggunakan email Untirta (**nim_mahasiswa@untirta.ac.id**). Untuk mengetahui password email masing-masing bisa menghubungi registrasi@untirta.ac.id

Berikut adalah persyaratan-persyaratan yang harus dilengkapi.

1. **Menunda pembarayan/Perpanjangan Pembayaran**

    a. Surat permohonan dari orang tua yang berisi kepastian tanggal akan membayar UKT (format pdf)
    b. Kartu Tanda Mahasiwa (format jpg)
    c. Kartu Keluarga (format pdf)
    d. Setelah persyaratan a - c lengkap, lakukan pendaftaran secara *online* [**di sini**](https://docs.google.com/forms/d/e/1FAIpQLSdEm4szZhgay61yOTdsaCWWGIW6gChpHyzKFVu6RdKMao2z1Q/viewform){target="_blank"}

$~$

2. **Penyesuaian UKT (PHK dan Pensiun)**

    a. Surat PHK/Diberhentikan/Pensiun (format pdf)
    b. Kartu Tanda Mahasiwa (format jpg)
    c. Bukti Pembayaran UKT/SPP semester berjalan (format pdf)
